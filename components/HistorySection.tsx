...
export default function HistorySection() {
  ...
  return (
    <section
      id="history"
      className="min-h-screen max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-12 sm:py-20 flex flex-col justify-center bg-white"
    >
      {/* Title */}
      <div className="text-center mb-6 sm:mb-10">
        <span className="text-red-500 font-bold tracking-widest text-xs sm:text-sm uppercase mb-2 block">
          OUR STORY
        </span>
        <h2 className="text-3xl sm:text-5xl md:text-6xl font-black text-gray-900 tracking-tight">
          History
        </h2>
      </div>
      ...
      <div className="relative w-full my-4 sm:my-8 group">
        ...
        <div
          ref={sliderRef}
          className="flex overflow-x-auto gap-4 sm:gap-6 pb-4 sm:pb-6 cursor-grab active:cursor-grabbing scroll-smooth select-none scrollbar-none"
          style={{
        ...
        >
          {images.map((image, index) => (
            <div
              key={index}
              className="flex-shrink-0 w-[88%] sm:w-[60%] md:w-[48%] aspect-[16/10] relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-md border border-gray-100"
            ...
            >
              <Image
                ...
                fill
                unoptimized
                sizes="(max-width: 640px) 88vw, (max-width: 768px) 60vw, 48vw"
      ...
      <motion.div
        ...
        className="max-w-3xl mx-auto text-left mt-6 sm:mt-8 flex flex-col gap-4 sm:gap-6"
      >
        <p className="text-gray-700 text-sm sm:text-lg md:text-xl font-normal leading-relaxed">
        ...
        <p className="text-gray-500 text-xs sm:text-base leading-relaxed font-light">
